#!/bin/bash
# Multi-turn CodeGym Tool-Calling with ECHO credit assignment
# 4 nodes x 8 H100-80GB, Qwen3-32B, Megatron backend, SGLang rollout
#
# Run from project root:
#   bash examples/sglang_multiturn/run_qwen3-32b_codegym_megatron_echo-ca.sh
...
VALIDATION_DATA_DIR="${VALIDATION_DATA_DIR:-${PROJECT_DIR}/val_outputs_codegym_echo}"
...
# ---- Training with SUPO/ECHO on CodeGym ----
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3-32b_codegym_megatron-echo-ca-4k-s7' \
    trainer.default_local_dir="${CKPT_DIR:-${PROJECT_DIR}/ckpt}/qwen3-32b_codegym_megatron-echo-ca-4k-s7" \
