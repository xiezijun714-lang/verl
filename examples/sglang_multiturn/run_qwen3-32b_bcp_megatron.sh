...
# TP=2, PP=1, CP=4, DP=4 for training; TP=4 for inference
#
# Parallelism layout (32 GPUs total):
#   Training: TP=2 × PP=1 × CP=4 = 8 GPUs per replica, DP=4
#   Inference: TP=4, n=8 rollout replicas (2 per DP rank)
#
...
mkdir -p "$LOG_DIR"
LOG_FILE="${LOG_DIR}/megatron_run.log"
