...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen3-32b_bcp_megatron-echo-e2e-32k-s5' \
    trainer.default_local_dir="${CKPT_DIR:-${PROJECT_DIR}/ckpt}/qwen3-32b_bcp_megatron-echo-e2e-32k-s5" \
