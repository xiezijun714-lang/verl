...
#
# Run from project root: bash examples/sglang_multiturn/run_qwen3-32b_bcp_megatron_echo-ca_fully_async.sh
...
DEFAULT_EXPERIMENT_NAME="qwen3-32b_bcp_megatron-echo-ca-fully-async-32k-s5"
...
echo "[config] entry=echo-ca_fully_async, trainer GPUs=${TRAINER_TOTAL_GPUS}, rollout GPUs=${ROLLOUT_TOTAL_GPUS}"
