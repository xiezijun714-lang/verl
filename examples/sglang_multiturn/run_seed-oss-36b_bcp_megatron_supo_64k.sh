#!/bin/bash
# BrowseComp-Plus SUPO with Seed-OSS-36B-Instruct at 64K working context.
#
# Run from project root:
#   bash examples/sglang_multiturn/run_seed-oss-36b_bcp_megatron_supo_64k.sh
...
export WORKING_CONTEXT_LENGTH="${WORKING_CONTEXT_LENGTH:-65536}"
...
export BCP_LOG_FILE="${BCP_LOG_FILE:-/root/paddlejob/workspace/env_run/xzj/echo/logs/megatron_seed_oss_supo_64k_run.log}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-seed-oss-36b_bcp_megatron-supo-64k}"
export VALIDATION_DATA_DIR="${VALIDATION_DATA_DIR:-/root/paddlejob/workspace/env_run/xzj/echo/val_outputs_seed_oss_supo_64k}"

exec bash "${SCRIPT_DIR}/run_qwen3-32b_bcp_megatron_supo.sh"
